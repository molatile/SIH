...
const Languages = () => {
  ...
  return (
    <div className="pt-24 min-h-screen flex flex-col relative bg-ivory overflow-y-auto overflow-x-hidden">
      <div className="flex flex-col md:flex-row relative w-full mb-12">
        {/* Map Section */}
      ...
      {/* Translator Panel below the map section */}
