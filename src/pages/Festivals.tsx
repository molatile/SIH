    ...
    <div className="pt-24 pb-12 min-h-screen bg-ivory">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-yatra text-indigo mb-4">Vibrant Festivals</h1>
            <div className="w-24 h-1 bg-saffron mx-auto rounded-full mb-6" />
            <p className="text-lg text-indigo/70 max-w-2xl mx-auto">
              Experience the joy, colors, and devotion of India's grandest celebrations.
            </p>
          </motion.div>
        </div>
            ...
            >
              ...
              >
                ...
                <div className="p-6 text-center bg-white flex-1 flex flex-col justify-center">
                  <h3 className="text-2xl font-yatra text-indigo mb-2">{festival.name}</h3>
                  <p className="text-saffron font-medium flex items-center justify-center gap-1">
                    <MapPin size={16} /> {festival.region}
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="md:w-2/5 h-64 md:h-auto relative shrink-0">
                ...
                <div className="absolute bottom-4 left-4 right-4 md:hidden text-white">
                  <h2 className="text-3xl font-yatra mb-1 drop-shadow-md">{selectedFestival.name}</h2>
                  <p className="flex items-center gap-1 text-white/90 text-sm">
                    <MapPin size={16} className="text-saffron" /> {selectedFestival.region}
                  </p>
                </div>
              </div>
              ...
              <div className="md:w-3/5 p-6 md:p-8 overflow-y-auto custom-scrollbar bg-ivory">
                <div className="hidden md:block mb-8 border-b border-indigo/10 pb-4">
                  <h2 className="text-4xl font-yatra text-indigo mb-2">{selectedFestival.name}</h2>
                  <p className="flex items-center gap-1 text-saffron font-medium">
                    <MapPin size={18} /> {selectedFestival.region}
                  </p>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <p className="text-indigo/80 leading-relaxed">{selectedFestival.info}</p>
                  </motion.div>
                  ...
                  >
                    ...
                    <p className="text-indigo/80 leading-relaxed">{selectedFestival.history}</p>
                  </motion.div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    >
                      ...
                      <p className="text-sm text-indigo/80 leading-relaxed">{selectedFestival.trivia}</p>
                    </motion.div>
                    ...
                    >
                      ...
                      <p className="text-sm text-indigo/80 leading-relaxed">{selectedFestival.funFact}</p>
                    </motion.div>
                  </div>
                </div>
              </div>
